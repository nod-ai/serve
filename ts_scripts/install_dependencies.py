...
class Common:
    ...
    def install_python_packages(self, cuda_version, rocm_version, requirements_file_path, nightly):
        ...
        if nightly:
            ...
            self.install_torch_packages(cuda_version=cuda_version)
        elif rocm_version:
            self.install_torch_packages(rocm_version=rocm_version)
        else:
...
if __name__ == "__main__":
    ...
    install_dependencies(cuda_version=args.cuda, rocm_version=args.rocm, nightly=args.nightly_torch)
