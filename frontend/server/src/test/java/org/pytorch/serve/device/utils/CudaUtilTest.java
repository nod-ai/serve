...
public class CudaUtilTest {
    ...
    public void testSmiOutputToUpdatedAccelerators() {
        String smiOutput = "index,gpu_name,utilization.gpu,utilization.memory,memory.used\n" +
        ...
        ArrayList<Accelerator> accelerators = cudaUtil.smiOutputToUpdatedAccelerators(smiOutput, parsedGpuIds);
        ...
        Assert.assertEquals(
                accelerator1.getAcceleratorModel(),
                "NVIDIA GeForce RTX 3080");
        Assert.assertEquals((float) accelerator1.getUsagePercentage(), 50f);
        Assert.assertEquals((float) accelerator1.getMemoryUtilizationPercentage(),
                60f);
        Assert.assertEquals((int) accelerator1.getMemoryUtilizationMegabytes(),
                8000);
        ...
        Assert.assertEquals((float) accelerator2.getMemoryUtilizationPercentage(),
                80f);
        Assert.assertEquals((int) accelerator2.getMemoryUtilizationMegabytes(),
                16000);
    }
