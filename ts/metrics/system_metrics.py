...
def collect_gpu_metrics(num_of_gpus):
    ...
    :param num_of_gpus: Amount of all available GPUs.
    :return:
    """
    for gpu_index in range(num_of_gpus):
        if torch.version.cuda:
            ...
            # https://github.com/pytorch/pytorch/blob/main/torch/cuda/__init__.py#L1171
...
def gpu_utilization(num_of_gpus):
    ...
    :param num_of_gpu: Amount of all available GPUs.
    :return:
    """
    if num_of_gpus <= 0:
        return
